...
setw -g window-status-format "#[fg=colour8]#I│#(basename #{pane_current_path}):#W#{?#{==:#{window_panes},1},,:#P-#{window_panes}}:#F"
setw -g window-status-current-format "#[fg=colour5,bold]#I│#(basename #{pane_current_path}):#W#{?#{==:#{window_panes},1},,:#P-#{window_panes}}:#F"
